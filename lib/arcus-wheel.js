 ...
 */
function contain(degrees) {

    if (degrees > 360)  { 
        degrees = contain(degrees - 360); 
    }
...
module.exports = {
    ...
    moveGValueOnYWheel: function (base, degrees) {
        var result = GtoY(base) + degrees;
        return YtoG(contain(result));
    },
    ...
    moveYValueonGWheel: function (base, degrees) {
        var result = YtoG(base) + degrees;
        return GtoY(contain(result));
    }
